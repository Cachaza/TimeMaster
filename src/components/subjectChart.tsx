...
function rellenarArray(inputArray: { date: string, workedTime: number }[], startDate: Date, lastDate: Date): { date: string, workedTime: number }[] {
...
export default function SubjectChart({ subjectId, startDate, endDate, subjectName }: Props) {
    const data = api.asignaturas.getUserSubjetTimes.useQuery({ subjectId: subjectId, startDate: startDate, endDate: endDate});
    ...
    return(
        <div className="col">
            ...
            <AreaChart
              ...
              <Area type="monotone" dataKey="workedTime" stroke="#8884d8" fill="#8884d8" />
            </AreaChart>
            </ResponsiveContainer>

...
const EditarAsignatura: React.FC<Asignatura> = ({
  Inombre,
  ItiempoTrabajo,
  ItiempoDescanso,
  ItiempoObjetivo,
                            ...
                            <div className="flex flex-col items-center justify-center py-2 px-14 text-center text-black">
                              ...
                              <div className="pt-3">
                                <input
                                  ...
                                  className="focus:ring-blue-500, rounded-md border border-gray-300 p-1 text-black focus:border-blue-500 focus:outline-none focus:ring-1"
                                />
                                ...
                                <input
                                  ...
                                  value={tiempoTrabajo}
                                  onChange={(e) =>
                                    setTiempoTrabajo(parseInt(e.target.value))
                                  }
                                  className="focus:ring-blue-500, rounded-md border border-gray-300 p-1 text-black focus:border-blue-500 focus:outline-none focus:ring-1"
                                />
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setTiempoDescanso(parseInt(e.target.value))
                                  }
                                  className="focus:ring-blue-500, rounded-md border border-gray-300 p-1 text-black focus:border-blue-500 focus:outline-none focus:ring-1"
                                />
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setTimepoObjetivo(parseInt(e.target.value))
                                  }
                                  className="focus:ring-blue-500, rounded-md border border-gray-300 p-1 text-black focus:border-blue-500 focus:outline-none focus:ring-1"
                                />
                                ...
                                <input
                                  ...
                                  value={videoUrlForm}
                                  onChange={(e) =>
                                    setVideoUrlForm(e.target.value)
                                  }
                                  className="focus:ring-blue-500, rounded-md border border-gray-300 p-1 text-black focus:border-blue-500 focus:outline-none focus:ring-1"
                                />
                              </div>
